...
/**
 * @param {{ messages: Array<{ id: string, role: string, content: string, telemetrySnapshot?: object | null, quality?: number | null, resonance?: { excerpt: string, capturedAt: number } | null }>, sessionCostUsd: number, telemetrySelectionId: string | null }} payload
 */
